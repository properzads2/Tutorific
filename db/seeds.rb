...
desmond = Student.create(first_name: "Desmond", last_name: "Floyd", bio: "Not named after the whiskey. I promise! Loves learning about chemistry")
...
abdul = Student.create(first_name: "Abdul", last_name: "Scott", bio: "Best boss at Dunder Mifflin. Interested in biochemistry.")
...
ts_3 = Tutor_Subject.create(tutor_id: .id, subject_id: history.id)
...
st_2 = Student_Tutor.create(tutor_subject_id: ts_2.id, student_id: .id, status: "Current")
st_3 = Student_Tutor.create(tutor_subject_id: ts_3.id, student_id: kevin.id, status: "Denied")
...
st_8 = Student_Tutor.create(tutor_subject_id: ts_8.id, student_id: peter.id, status: "Denied")
...
review_3 = Review.create(student_tutor_id: st_3.id, rating: 7, comments: "Malik is good at explaining some historical concepts, but not others")
