...
class TutorSubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor_subject" do
    assert_difference('TutorSubject.count') do
      post tutor_subjects_url, params: { tutor_subject: { subject_id: @tutor_subject.subject_id, tutor_id: @tutor_subject.tutor_id } }
    end
  ...
  test "should update tutor_subject" do
    patch tutor_subject_url(@tutor_subject), params: { tutor_subject: { subject_id: @tutor_subject.subject_id, tutor_id: @tutor_subject.tutor_id } }
